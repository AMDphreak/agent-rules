...
Canonical: `$AGENT_RULES_PATH/skills/<name>/` (this fork for personal; `dev-centr/agent-rules` for team).
...
Thin pointer only in `RULES.md`. Structure leftover: Cursor `create-skill`.
...
- [ ] Optional one-line pointer; body not pasted into User Rules
